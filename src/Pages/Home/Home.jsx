const Home = () => {
  return (
    <div>
<div class="h-screen w-full mx-auto lg:flex">
  <div class="mx-auto lg:w-9/12 xl:w-7/12">
  ...
  <div class="relative my-auto hidden h-full text-green-600 lg:block lg:w-3/12 xl:w-5/12">
    <img class=" w-full mt-24 rounded-lg object-cover" src="https://images.unsplash.com/photo-1425913397330-cf8af2ff40a1?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1074&q=80" alt="" />
  </div>
</div>
